...
J(\boldsymbol{\theta}) = \frac{1}{2} \sum_{i=1}^{N} \left( f_\theta(\mathbf{x}^{(i)}) - y^{(i)} \right)^2 = \frac{1}{2} \sum_{i=1}^{N} \left( \theta_0 x_0^{(i)} + \theta_1 x_1^{(i)} + \dots + \theta_n x_n^{(i)} - y^{(i)} \right)^2
...
$$
\frac{\partial}{\partial \theta_j} J(\boldsymbol{\theta}) = \sum_{i=1}^{N} \left( f_\theta(\mathbf{x}^{(i)}) - y^{(i)} \right) \cdot x_j^{(i)}
$$
...
\frac{\partial}{\partial \theta_j} J(\boldsymbol{\theta}) = \sum_{i=1}^{N} \left( f_\theta(\mathbf{x}^{(i)}) - y^{(i)} \right) x_j^{(i)}
...
\theta_j = \theta_j - \gamma \sum_{i=1}^{N} \left( f_\theta(\mathbf{x}^{(i)}) - y^{(i)} \right) x_j^{(i)}
